...
class BiliBiliSite {
  ...
  Future<VideoSearchResult> getSearchVideoLists(String keyword, String order, {int page = 1}) async {
    try {
      ...
      return VideoSearchResult(hasMore: queryList.length > 0, items: items);
    } catch (e) {
      log(e.toString(), name: 'getSearchVideoLists');
      return VideoSearchResult(hasMore: false, items: []);
    }
  }
  ...
  Future<List<VideoMediaInfo>> getRoomListDetail(String bvid) async {
    try {
      ...
      log(e.toString(), name: 'getRoomListDetail');
      return [];
    }
  }
  ...
  Future<List<VideoMediaSeries>> getSeasonsSeries(String mid) async {
    ...
    try {
      ...
      log(e.toString(), name: 'getSeasonsSeries');
    }
  ...
  Future<VideoPlaySource?> getVideoDetail(int avid, int cid, String bvid, {String qn = '80'}) async {
    try {
      ...
      log(e.toString(), name: 'getVideoDetail');
    }
    return null;
  }
  ...
  Future<BiliUpInfo> getVidoeInfo(BilibiliVideoItem video) async {
    ...
    try {
      cookie = settings.bilibiliCookie.value;
      var header = _buildCommonHeaders(referer: "https://www.bilibili.com/video/${video.bvid}");
      var result = await HttpClient.instance.getJson(
  ...
  Future<VideoPlaySource?> getAudioDetail(int avid, int cid, String bvid, {String qn = '32'}) async {
    try {
      ...
      log(e.toString(), name: 'getAudioDetail');
    }
    return null;
  }
  ...
  Future<Map<String, dynamic>> getMusicInfo(String musicId) async {
    try {
      ...
      var header = _buildCommonHeaders(referer: "https://music.bilibili.com/");
      var result = await HttpClient.instance.getJson(
      ...
      log(e.toString(), name: 'getMusicInfo');
    }
    return {
      'album': '',
      'title': '',
  ...
  Future<String> getBilibiliLyrics(String url) async {
    try {
      ...
      log(e.toString(), name: 'getBilibiliLyrics');
      return '';
    }
  }
    ...
    try {
      ...
      for (var i = 0; i < lyricResults.length; i++) {
        ...
        try {
          ...
          log(e.toString(), name: 'getSearchLyrics.convert');
        }
  ...
  Future<List<VideoMediaInfo>> getArchivesVideos(
    ...
    try {
      ...
      var header = _buildCommonHeaders(
      ...
      log(e.toString(), name: 'getArchivesVideos');
    }
    return videoList;
  }
  ...
  Future<List<VideoMediaInfo>> getUpAllVideos(int page, int size, String mid) async {
    ...
    try {
      ...
      log(e.toString(), name: 'getUpAllVideos');
    }
    return videoList;
  }
